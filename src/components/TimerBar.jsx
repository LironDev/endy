  ...
  return (
    <div className="w-full flex items-center gap-2" dir="rtl">
      ...
      <motion.span
        ...
        className="text-purple-700 dark:text-purple-300 text-xs font-mono w-8 text-center flex-shrink-0"
      >
        {seconds}
      </motion.span>

      {/* Progress bar */}
      <div className="flex-1 h-2 bg-purple-200/80 dark:bg-purple-900/60 rounded-full overflow-hidden">
        <motion.div
      ...
      <span className="text-purple-500/60 dark:text-purple-400/50 text-xs flex-shrink-0">⏱</span>
    </div>
  );
}
